...
class UpcomingScheduleRepositoryTest {
    private lateinit var scheduleRepository: UpcomingScheduleRepository
    private lateinit var memoryDataStore: UpcomingScheduleMemoryDataStore
    private lateinit var remoteDataStore: UpcomingScheduleRemoteDataStore
    ...
    @Before
    fun setUp() {
        memoryDataStore = Mockito.mock(UpcomingScheduleMemoryDataStore::class.java)
        remoteDataStore = Mockito.mock(UpcomingScheduleRemoteDataStore::class.java)
        scheduleDataToEntityMapper = ScheduleDataToEntityMapper()
        scheduleEntityToDataMapper = ScheduleEntityToDataMapper()

        scheduleRepository = UpcomingScheduleRepository(
            memoryDataStore,
            remoteDataStore,
