...
class ScheduleUpcomingFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        swlSchedule.setOnRefreshListener { vm.fetchNextMatch() }
    }
    ...
    private fun handleState(viewState: ScheduleViewState?) {
        ...
        viewState?.data?.get(ScheduleViewModel.NEXT)?.let { adapter.updateData(it) }
